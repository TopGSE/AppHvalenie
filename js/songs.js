const songs = [
    {
		...
		[G] 'Tis grace has brought me [C] safe thus [G] far
		And [C] grace will [G] lead [D] me [G] home.
	
		The [G] Lord has promised [C] good to [G] me
		His word my hope se[D]cures
		[G] He will my shield and [C] portion [G] be
		As [C] long as [G] life [D] en[G]dures.
	
		Yea, [G] when this flesh and [C] heart shall [G] fail
		And mortal life shall [D] cease
		[G] I shall possess, with[C]in the [G] veil
		A [C] life of [G] joy and [D] peace.
	
		When [G] we've been there ten [C] thousand [G] years
		Bright shining as the [D] sun
		[G] We've no less days to [C] sing God's [G] praise
		Than [C] when we [G] first [D] be[G]gun.`
    },
    {
        ...
        chords: `
        [C] O Lord my God, when [F] I in awesome [C] wonder
        Consider all the [G] worlds Thy Hands have [C] made
        I see the stars, I [F] hear the rolling [C] thunder
        Thy power through[G]out the [C] universe dis[G]played.`
    },
	{
		title:"Отче Наш",
		lyrics:`
